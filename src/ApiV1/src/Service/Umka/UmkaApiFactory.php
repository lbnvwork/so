...
/**
 * Class UmkaApiFactory
 *
 * @package ApiV1\Service\Umka
 */
class UmkaApiFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        $config = [
            ...
            'username' => isset($settings[SettingService::CASHIER_LOGIN]) ? $settings[SettingService::CASHIER_LOGIN]->getValue() : 'test',
