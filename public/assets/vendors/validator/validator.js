...
var validator = (function($){
    ...
    */
    message = {
        invalid         : 'Не корректно заполненное поле',
        checked         : 'Должно быть установлено',
        empty           : 'заполните поле',
        min             : 'Текст слишком короткий',
        max             : 'Текст слишком длинный',
        number_min      : 'too low',
        number_max      : 'too high',
        url             : 'Не корректный Url',
        number          : 'Значение не число',
        email           : 'E-mail адрес не верный',
        email_repeat    : 'emails do not match',
        password_repeat : 'passwords do not match',
        repeat          : 'no match',
        complete        : 'input is not complete',
        select          : 'Пожалуйста выберите один из пунктов'
    };
